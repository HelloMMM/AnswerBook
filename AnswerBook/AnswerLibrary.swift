...
var answerEnList: [String] =
    ["Hear from experts.", "Take a bold attitude.", "Don't bet on this.", "Study and then enjoy it.",
     ...
     "You'll find everything you need to know.", "Be a little patient.", "You'll be glad you did.", "Write it down.",
     "It's a very rough time.", "Change your focus.", "Don't fall into your feelings.",
     ...
     "You will not be able to compromise.", "Believe in the professional.", "unpredictable.", "Living in the moment.",
     "Enjoy it.", "Keep curious.", "Please secrecy.", "Do not trust anyone.", "Just try.", "Gladly accepted.",
     "Adjust properly.", "You will not regret.", "According to their own ideas to do.", "Abandon the old method.",
     "Accept the new method.", "Do not alone.", "Do not group.", "Cooperation with others.", "Bet once.",
     "Now focus on the work.", "Rain or shine.", "Do not look too close.", "The closer the better.",
     "The farther the better.", "better not.", "Prevention villain.", "Believe it.", "Finish what you have at hand.",
     "It's not clear yet.", "Must work hard.", "Maybe it's time to give up.",
     "Miss this opportunity, don't know how long to wait.", "Take a break.", "Settle down early.",
     "Waiting for an opportunity.", "It will not be desirable.", "Don't be too nervous.", "To a certain height to say.",
     "To get a clearer vision.", "Straight Adventure.", "Save your energy.", "The actual point.",
     "He will walk with you.", "Don't Overdone.", "Convergence point.", "Now you can.",
     ...
     "No matter how you do, can't change.", "Difficult process, but the result is valuable.", "It will be a problem.",
     "You definitely need support.", "Related issues will be one after another.",
